...
While this is just one specific example of similarites across the co-members, we can use text mining concepts like term-frequency/invcerse document frequency plots to examine which words may represent a cluster.
